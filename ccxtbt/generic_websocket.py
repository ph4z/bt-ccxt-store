...
class GenericWebsocket:
    ...
    def __init__(self, host, logLevel='INFO', max_retries=5, create_event_emitter=None, max_size=None, ssl_context=None):
        self.host = host
    ...
    async def _run_socket(self):
        ...
        while retries < self.max_retries and self.attempt_retry:
            try:
                async with websockets.connect(self.host, max_size=self.max_size, ssl=self.ssl_context) as websocket:
